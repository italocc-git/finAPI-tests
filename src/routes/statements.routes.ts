...
import { TransfersStatementController } from '../modules/statements/useCases/transfersStatement/TransfersStatementController';
...
const transfersStatementController = new TransfersStatementController();
...
statementRouter.post('/transfers/:user_id', transfersStatementController.execute);
